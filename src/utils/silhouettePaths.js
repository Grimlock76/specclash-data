// Silhouette path data shared by CarSilhouette.jsx and the matchup-card
// exporter. All hand-authored original vector art (see CarSilhouette.jsx).
export const DARK = '#0d0d0d'
export const poly = pts => (pts.startsWith('M') ? pts : 'M' + pts.split(' ').join(' L') + ' Z')
