...
const s207 = JSON.parse(fs.readFileSync('src/data/supplement207.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s207.specs)) {
...
console.log('makes.json updated with supplement207')
