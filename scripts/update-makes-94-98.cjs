...
const supplements = [94, 95, 96, 97, 98].map(n =>
...
['Cadillac','Buick','Mercury','Plymouth','De Soto','Studebaker','Hudson','Nash','Packard','Vauxhall','Morgan','De Tomaso','Alpine'].forEach(m => {
