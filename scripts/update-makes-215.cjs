...
const s215 = JSON.parse(fs.readFileSync('src/data/supplement215.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s215.specs)) {
...
console.log('makes.json updated with supplement215')
