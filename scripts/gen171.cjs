...
// ─────────────────────────────────────────────────────────────
// PORSCHE 911 — 2024 trim gaps
// GT3 RS, Turbo, Turbo Cabriolet, Turbo S, Turbo S Cabriolet
// ─────────────────────────────────────────────────────────────
specs[`Porsche|911|2024|GT3 RS`] = {
  ...
  acceleration: 3.2, topSpeed: 296, price: p(555000), aspiration: 'NA'
}
specs[`Porsche|911|2024|Turbo`] = {
  ...
  acceleration: 3.0, topSpeed: 320, price: p(380000), aspiration: 'Turbo'
}
specs[`Porsche|911|2024|Turbo Cabriolet`] = {
  engine: '3.8L Flat-6 Twin-Turbo', fuelType: 'petrol', displacement: 3745,
  cylinders: 6, drivetrain: 'AWD', transmission: '8-speed PDK',
  power: 382, torque: 570, weight: 1635, seats: 4,
  fc: 12.0, fh: 9.0, fx: 16.9,
  acceleration: 3.1, topSpeed: 320, price: p(400000), aspiration: 'Turbo'
}
specs[`Porsche|911|2024|Turbo S`] = {
  ...
  acceleration: 2.7, topSpeed: 330, price: p(484000), aspiration: 'Turbo'
}
specs[`Porsche|911|2024|Turbo S Cabriolet`] = {
  engine: '3.8L Flat-6 Twin-Turbo', fuelType: 'petrol', displacement: 3745,
  cylinders: 6, drivetrain: 'AWD', transmission: '8-speed PDK',
  power: 478, torque: 800, weight: 1656, seats: 4,
  fc: 12.0, fh: 9.1, fx: 16.9,
  acceleration: 2.7, topSpeed: 330, price: p(465000), aspiration: 'Turbo'
}

// ─────────────────────────────────────────────────────────────
// PORSCHE TAYCAN — 2024 trim gaps
// Sport Turismo, Taycan 4, Taycan 4S, Taycan Turbo
// ─────────────────────────────────────────────────────────────
specs[`Porsche|Taycan|2024|Sport Turismo`] = {
  ...
  acceleration: 5.5, topSpeed: 230, price: p(156000), aspiration: 'Electric'
}
specs[`Porsche|Taycan|2024|Taycan 4`] = {
  ...
  fc: null, fh: null, fx: null,
  acceleration: 4.8, topSpeed: 230, price: p(168000), aspiration: 'Electric'
}
specs[`Porsche|Taycan|2024|Taycan 4S`] = {
  engine: 'Dual Motor Electric', fuelType: 'electric', battery: '93.4 kWh', range: 532,
  drivetrain: 'AWD', transmission: '2-speed auto',
  power: 390, torque: 650, weight: 2295, seats: 4,
  fc: null, fh: null, fx: null,
  acceleration: 4.0, topSpeed: 250, price: p(189900), aspiration: 'Electric'
}
specs[`Porsche|Taycan|2024|Taycan Turbo`] = {
  engine: 'Dual Motor Electric', fuelType: 'electric', battery: '93 kWh', range: 395,
  drivetrain: 'AWD', transmission: '1-speed auto',
  power: 500, torque: 910, weight: 2235, seats: 5,
  fc: null, fh: null, fx: null,
  acceleration: 2.8, topSpeed: 260, price: p(287000), aspiration: 'Electric'
}

// ─────────────────────────────────────────────────────────────
// MERCEDES S-CLASS — 2024 trim gaps
// S 450, S 580 4MATIC, S 63 AMG e Performance, Maybach S 580 4MATIC
// ─────────────────────────────────────────────────────────────
specs[`Mercedes-Benz|S-Class|2024|S 450`] = {
  ...
  acceleration: 5.9, topSpeed: 250, price: p(259900), aspiration: 'Turbo'
}
specs[`Mercedes-Benz|S-Class|2024|S 580 4MATIC`] = {
  ...
  acceleration: 4.3, topSpeed: 250, price: p(349900), aspiration: 'Turbo'
}
specs[`Mercedes-Benz|S-Class|2024|S 63 AMG e Performance`] = {
  ...
  acceleration: 3.3, topSpeed: 250, price: p(519900), aspiration: 'Turbo'
}
specs[`Mercedes-Benz|S-Class|2024|Maybach S 580 4MATIC`] = {
  engine: '4.0L V8 Biturbo MHEV', fuelType: 'petrol', displacement: 3982,
  cylinders: 8, drivetrain: 'AWD', transmission: '9-speed auto',
  power: 350, torque: 700, weight: 2395, seats: 4,
  fc: 12.3, fh: 9.4, fx: 17.3,
  acceleration: 4.8, topSpeed: 250, price: p(689900), aspiration: 'Turbo'
}

// ─────────────────────────────────────────────────────────────
// MERCEDES SL — 2024 trim gaps
// SL 55 AMG, SL 63 AMG 4MATIC+
// ─────────────────────────────────────────────────────────────
specs[`Mercedes-Benz|SL|2024|SL 55 AMG`] = {
  ...
  power: 430, torque: 700, weight: 1950, seats: 2,
  fc: 13.0, fh: 9.6, fx: 18.3,
  acceleration: 3.7, topSpeed: 300, price: p(390000), aspiration: 'Turbo'
}
specs[`Mercedes-Benz|SL|2024|SL 63 AMG 4MATIC+`] = {
  engine: '4.0L V8 Biturbo AMG', fuelType: 'petrol', displacement: 3982,
  cylinders: 8, drivetrain: 'AWD', transmission: '9-speed AMG Speedshift',
  power: 430, torque: 900, weight: 1990, seats: 2,
  fc: 12.9, fh: 9.9, fx: 18.2,
  acceleration: 3.6, topSpeed: 275, price: p(449900), aspiration: 'Turbo'
}

// ─────────────────────────────────────────────────────────────
// MERCEDES AMG GT — 2024 trim gaps
// AMG GT 55 4MATIC+, AMG GT 63 S E Performance
// ─────────────────────────────────────────────────────────────
specs[`Mercedes-Benz|AMG GT|2024|AMG GT 55 4MATIC+`] = {
  engine: '4.0L V8 Biturbo AMG', fuelType: 'petrol', displacement: 3982,
  cylinders: 8, drivetrain: 'AWD', transmission: '9-speed AMG Speedshift',
  power: 320, torque: 700, weight: 1870, seats: 4,
  fc: 12.2, fh: 9.3, fx: 17.1,
  acceleration: 4.0, topSpeed: 290, price: p(269900), aspiration: 'Turbo'
}
specs[`Mercedes-Benz|AMG GT|2024|AMG GT 63 S E Performance`] = {
  engine: '4.0L V8 PHEV AMG', fuelType: 'PHEV', displacement: 3982,
  cylinders: 8, drivetrain: 'AWD', transmission: '9-speed MCT',
  power: 620, torque: 1400, weight: 2370, seats: 4,
  fc: 2.4, fh: null, fx: null,
  acceleration: 2.9, topSpeed: 316, price: p(489900), aspiration: 'Turbo'
}

// ─────────────────────────────────────────────────────────────
// LEXUS ES — 2024 trim gaps: ES 300h F Sport, ES 300h Sports Luxury
// ─────────────────────────────────────────────────────────────
specs[`Lexus|ES|2024|ES 300h F Sport`] = {
  ...
  acceleration: 8.1, topSpeed: 180, price: p(82990), aspiration: 'NA'
}
specs[`Lexus|ES|2024|ES 300h Sports Luxury`] = {
  engine: '2.5L I4 Atkinson Hybrid', fuelType: 'hybrid', displacement: 2487,
  cylinders: 4, drivetrain: 'FWD', transmission: 'e-CVT',
  power: 160, torque: 221, weight: 1720, seats: 5,
  fc: 4.4, fh: 3.6, fx: 5.8,
  acceleration: 8.1, topSpeed: 180, price: p(77990), aspiration: 'NA'
}

// ─────────────────────────────────────────────────────────────
// LEXUS GX — 2024 trim gaps: GX 550 F Sport, GX 550 Sports Luxury
// ─────────────────────────────────────────────────────────────
specs[`Lexus|GX|2024|GX 550 F Sport`] = {
  ...
  acceleration: 6.3, topSpeed: 200, price: p(121990), aspiration: 'Turbo'
}
specs[`Lexus|GX|2024|GX 550 Sports Luxury`] = {
  engine: '3.4L V6 Twin-Turbo', fuelType: 'petrol', displacement: 3444,
  cylinders: 6, drivetrain: 'AWD', transmission: '10-speed auto',
  power: 260, torque: 650, weight: 2390, seats: 7,
  fc: 12.4, fh: 9.7, fx: 16.9,
  acceleration: 6.3, topSpeed: 200, price: p(111990), aspiration: 'Turbo'
}

// ─────────────────────────────────────────────────────────────
// LEXUS LX — 2024 trim gaps: LX 600 F Sport, LX 600 Sports Luxury
// ─────────────────────────────────────────────────────────────
specs[`Lexus|LX|2024|LX 600 F Sport`] = {
...
specs[`Lexus|LX|2024|LX 600 Sports Luxury`] = {
  engine: '3.5L V6 Twin-Turbo', fuelType: 'petrol', displacement: 3446,
  cylinders: 6, drivetrain: 'AWD', transmission: '10-speed auto',
...
// ─────────────────────────────────────────────────────────────
// LEXUS RX — 2024 trim gaps: RX 350h, RX 350h F Sport, RX 500h F Sport Performance
// ─────────────────────────────────────────────────────────────
specs[`Lexus|RX|2024|RX 350h`] = {
  engine: '2.5L I4 Atkinson Hybrid', fuelType: 'hybrid', displacement: 2487,
  cylinders: 4, drivetrain: 'FWD', transmission: 'e-CVT',
  power: 179, torque: 221, weight: 1920, seats: 5,
  fc: 5.8, fh: 4.7, fx: 7.8,
  acceleration: 7.9, topSpeed: 180, price: p(80990), aspiration: 'NA'
}
specs[`Lexus|RX|2024|RX 350h F Sport`] = {
  ...
  acceleration: 7.2, topSpeed: 200, price: p(91990), aspiration: 'NA'
}
specs[`Lexus|RX|2024|RX 500h F Sport Performance`] = {
  ...
  acceleration: 5.0, topSpeed: 200, price: p(118990), aspiration: 'Turbo'
}

// ─────────────────────────────────────────────────────────────
// AUDI A5 — 2024 trim gaps: 45 TFSI quattro, S5
// ─────────────────────────────────────────────────────────────
specs[`Audi|A5|2024|45 TFSI quattro`] = {
  ...
  acceleration: 6.2, topSpeed: 250, price: p(71900), aspiration: 'Turbo'
}
specs[`Audi|A5|2024|S5`] = {
  ...
  acceleration: 4.5, topSpeed: 250, price: p(101900), aspiration: 'Turbo'
}
...
// ─────────────────────────────────────────────────────────────
const out = { specs }
fs.writeFileSync('src/data/supplement171.json', JSON.stringify(out, null, 2))
console.log(`supplement171.json written — ${Object.keys(specs).length} entries`)
