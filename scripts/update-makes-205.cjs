...
const s205 = JSON.parse(fs.readFileSync('src/data/supplement205.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s205.specs)) {
...
console.log('makes.json updated with supplement205')
