...
const supplements = [105, 106].map(n =>
...
['Simca','Lada','NSU','Caterham','Autobianchi','DAF','Matra','Riley','Wolseley','Singer','Standard','Reliant','Panhard','Innocenti','Ginetta','Marcos','Facel Vega'].forEach(m => {
