...
const s213 = JSON.parse(fs.readFileSync('src/data/supplement213.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s213.specs)) {
...
console.log('makes.json updated with supplement213')
