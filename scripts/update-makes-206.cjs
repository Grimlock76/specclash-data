...
const s206 = JSON.parse(fs.readFileSync('src/data/supplement206.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s206.specs)) {
...
console.log('makes.json updated with supplement206')
