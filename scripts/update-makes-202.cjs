...
const s202 = JSON.parse(fs.readFileSync('src/data/supplement202.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s202.specs)) {
...
console.log('makes.json updated with supplement202')
