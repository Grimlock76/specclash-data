...
const s212 = JSON.parse(fs.readFileSync('src/data/supplement212.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s212.specs)) {
...
console.log('makes.json updated with supplement212')
