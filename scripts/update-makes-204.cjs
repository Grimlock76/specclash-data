...
const s204 = JSON.parse(fs.readFileSync('src/data/supplement204.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s204.specs)) {
...
console.log('makes.json updated with supplement204')
