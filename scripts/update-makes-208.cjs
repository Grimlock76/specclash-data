...
const s208 = JSON.parse(fs.readFileSync('src/data/supplement208.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s208.specs)) {
...
console.log('makes.json updated with supplement208')
