...
const s210 = JSON.parse(fs.readFileSync('src/data/supplement210.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s210.specs)) {
...
console.log('makes.json updated with supplement210')
