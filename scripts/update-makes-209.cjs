...
const s209 = JSON.parse(fs.readFileSync('src/data/supplement209.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s209.specs)) {
...
console.log('makes.json updated with supplement209')
