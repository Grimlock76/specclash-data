...
const s203 = JSON.parse(fs.readFileSync('src/data/supplement203.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s203.specs)) {
...
console.log('makes.json updated with supplement203')
