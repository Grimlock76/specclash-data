...
const s211 = JSON.parse(fs.readFileSync('src/data/supplement211.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s211.specs)) {
...
console.log('makes.json updated with supplement211')
