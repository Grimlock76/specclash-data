...
const s217 = JSON.parse(fs.readFileSync('src/data/supplement217.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s217.specs)) {
...
console.log('makes.json updated with supplement217')
