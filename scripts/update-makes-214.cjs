...
const s214 = JSON.parse(fs.readFileSync('src/data/supplement214.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s214.specs)) {
...
console.log('makes.json updated with supplement214')
