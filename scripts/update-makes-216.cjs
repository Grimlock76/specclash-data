...
const s216 = JSON.parse(fs.readFileSync('src/data/supplement216.json', 'utf8'))

const affected = new Set()
for (const key of Object.keys(s216.specs)) {
...
console.log('makes.json updated with supplement216')
